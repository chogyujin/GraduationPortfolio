package com.DriverAssistSystem.clicknumberpicker;
...
public class ClickNumberPickerView extends PercentRelativeLayout {
    ...
    public void setUnable(boolean unable){
        if(unable) {
            flLeftPicker.setOnClickListener(PickerUnableListener);
            flRightPicker.setOnClickListener(PickerUnableListener);
        }
        else {
            flLeftPicker.setOnClickListener(leftPickerListener);
            flRightPicker.setOnClickListener(rightPickerListener);
    ...
    private OnClickListener PickerUnableListener = new OnClickListener() {
        @Override
